...
<!-- Mirrored from uitheme.net/orgomart/forgot-one.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Apr 2024 13:05:25 GMT -->
        ...
        <div class="row min-vh-100">
            ...
            <div class="col-xl-7 min-vh-100 align-items-center d-flex bg-dark-black rounded-3 overflow-hidden">
                <div
                    ...
                    <div class="card-body rounded-0 text-left p-4">
                        <h2 class="fw-700 display1-size display2-md-size mb-4 mt-0 white-text">Change <br>your password
                        </h2>
                        <form>
                            ...
                            <div class="form-check text-left mb-3">
                                ...
                                <label class="form-check-label font-xsss text-grey-500" for="exampleCheck4">Accept Term
                                    and Conditions</label>
                                <!-- <a href="#" class="fw-600 font-xsss text-grey-700 mt-1 float-right">Forgot your Password?</a> -->
                            </div>
                        </form>

                        <div class="col-sm-12 p-0 text-left mb-0">
                            <div class="form-group mb-1"><a href="login-one.html"
                                    class="text-center style2-input text-white fw-600 bg-current border-0 p-0 ">Change
                                    Password</a></div>
