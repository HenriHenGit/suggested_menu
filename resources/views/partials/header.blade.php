...
<div class="header-menu-mob pt-2 pb-2 shadow-xss position-fixed w-100 z-index-10 bg-white d-none d-block-md">
    <div class="container">
        <div class="row">
            <div class="col text-start"><button class="navbar-toggler border-0" type="button" data-bs-toggle="modal"
                    data-bs-target="#menumodal"><span class="navbar-toggler-icon"></span></button></div>
            <div class="col text-center"><a href="index-2.html"><img src="images/logo.png" alt="logo"
                        class="logo w-110 pt-1"></a></div>
            <div class="col text-end"><a href="#" class="nav-icon mt-1 d-inline-block" data-bs-toggle="modal"
                    data-bs-target="#cartmodal"><i class="feather-shopping-bag text-grey-500 font-xl"></i></a></div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-lg-12 d-flex">
                ...
                <div class="header-search ms-auto me-2 d-flex">
                    ...
                    <a href="{{ asset('admin') }}" class="nav-icon p-0"><img src="images/profile-4.png" alt="user"
                            class="w-40 mt-1"></a>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="dropdown dropdown-right border-0">
                    <button class="btn border-0 rounded-0 dropdown-toggle" type="button" data-bs-toggle="modal"
                        data-bs-target="#categorymodal"><i class="feather-align-left"></i> All Categories</button>
                    ...
                    <div class="navbar-collapse collapse show" id="main_nav" style="">
                        ...
                        <ul class="navbar-nav ms-auto">
                            <li class="nav-item text-grey-500 fw-500 font-xssss">Need help? Call Us : <a
                                    href="tel:03340005000" class="fw-700 text-current">+ 033 4000 5000</a></li>
                        </ul>
                    </div>
                </div>
            </div>
