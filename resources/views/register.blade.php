...
<!-- Mirrored from uitheme.net/orgomart/register-one.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Apr 2024 13:05:25 GMT -->
            ...
            <div class="col-xl-7 min-vh-100 align-items-center d-flex bg-dark-black rounded-3 overflow-hidden">
                <div
                    ...
                    <div class="card-body rounded-0 text-start p-4">
                        <h2 class="fw-700 display1-size display2-md-size mb-4 mt-0 white-text text-grey-900">Create
                            <br>your account</h2>
                        <form>
                            ...
                            <div class="form-check text-start mb-3">
                                ...
                                <label class="form-check-label font-xsss text-grey-500 white-text"
                                    for="exampleCheck3">Accept Term and Conditions</label>
                        ...
                        <div class="col-sm-12 p-0 text-start">
                            <div class="form-group mb-1"><a href="#"
                                    class="text-center style2-input text-white fw-600 bg-current border-0 p-0 ">Register</a>
                            </div>
                            <h6 class="text-grey-500 font-xsss fw-500 mt-0 mb-0 lh-32 white-text">Already have account
                                <a href="login-one.html" class="fw-700 ms-1">Login</a></h6>
                        </div>
