...
<!-- Mirrored from uitheme.net/orgomart/login-one.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Apr 2024 13:05:22 GMT -->
...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="images/favicon.html">
    <!-- Custom Stylesheet -->
    ...
    <div class="main-wrap min-vh-100">
        ...
        <div class="row min-vh-100">
            <div class="col-xl-5 d-none d-xl-block p-0 min-vh-100 bg-image-cover bg-image-bottomcenter bg-no-repeat posr"
                style="background-image: url(images/login-bg2.jpg);"></div>
                    ...
                    <div class="card-body rounded-0 text-start p-4">
                        ...
                        <form>
                            ...
                            <div class="form-check text-start mb-3">
                                ...
                                <label class="form-check-label font-xsss text-grey-500 white-text"
                                    for="exampleCheck5">Remember me</label>
                                <a href="forgot-one.html"
                                    class="fw-600 font-xsss text-grey-700 white-text mt-1 float-right">Forgot your
                                    Password?</a>
                            </div>
                        ...
                        <div class="col-sm-12 p-0 text-start">
                            <div class="form-group mb-1"><a href="#"
                                    class="bg-current text-center style2-input text-white fw-600 border-0 p-0 ">Login</a>
                            </div>
                            <h6 class="text-grey-500 font-xsss fw-500 mt-0 mb-0 lh-32">Dont have account <a
                                    href="register-one.html" class="fw-700 ms-1">Register</a></h6>
                        </div>
                        <div class="col-sm-12 p-0 text-center mt-2 mb-0">
                            ...
                            <h6 class="mb-0 d-inline-block fw-500 font-xsss text-grey-500 mb-3">Or, Sign in with your
                                social account </h6>
                            <div class="form-group mb-1"><a href="#"
                                    class="text-start style2-input text-grey-900 fw-600 bg-greylight border-0 p-0 mb-2"><img
                                        src="images/icon-1.png" alt="icon" class="ms-2 w-40 mb-1 me-lg-5 me-3"> Sign
                                    in with Google</a></div>
                            <div class="form-group mb-1"><a href="#"
                                    class="text-start style2-input text-white fw-600 bg-twiiter border-0 p-0 "><img
                                        src="images/icon-3.png" alt="icon" class="ms-2 w-40 mb-1 me-lg-5 me-3"> Sign
                            ...
                            <div class="col-sm-12 p-0 text-center mt-3 ">
                                ...
                                <div class="form-group mb-1"><a href="#"
                                        class="form-control text-left style2-input text-white fw-600 bg-facebook border-0 p-0 mb-2"><img
                                            src="images/icon-1.png" alt="icon" class="ms-2 w-40 mb-1 me-5"> Sign
                                        in with Google</a></div>
                                <div class="form-group mb-1"><a href="#"
                                        class="form-control text-left style2-input text-white fw-600 bg-twiiter border-0 p-0 "><img
                                            src="images/icon-3.png" alt="icon" class="ms-2 w-40 mb-1 me-5"> Sign
                                        in with Facebook</a></div>
                            </div>
                        </div>
                    </div>
...
<!-- Mirrored from uitheme.net/orgomart/login-one.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Apr 2024 13:05:24 GMT -->
